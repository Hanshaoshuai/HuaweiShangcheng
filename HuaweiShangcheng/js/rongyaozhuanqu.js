...
//		}
	...
	this._li[2].onmouseover=function(){
		...
		_foorer._li[2].style.background="#00b5e2";
	...
	this._li[3].onmouseover=function(){
		...
		_foorer._li[3].style.background="#00b5e2";
...
function Main(){
	...
	br.aa[3].style.background="#d1112c";
	this._time=0;
	this._timer=0;
	this._opacity=1;
	this._t=3;
		...
		br.aa[n].onmouseover=function(){
			...
			for(var e=0;e<br.aa.length;e++){
				...
				if(br.e==this.index){
					...
					br.aa[3].style.background="#363535";
				}			
			}
		}
